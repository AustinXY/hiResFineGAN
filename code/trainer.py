...
class FineGAN_trainer(object):
    ...
    def train(self):
        ...
        self.n_out = 26                 # Output size of the discriminator at the background stage; N X N where N = 24
        self.recp_field = 26            # Receptive field of each of the member of N X N
