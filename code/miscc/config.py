...
__C.FG_CATEGORIES = 20
__C.FINE_GRAINED_CATEGORIES = 200
__C.BG_CATEGORIES = 100
# __C.NUM_C_PER_B = 2
...
__C.TRAIN.BG_CONN_WT = 1.
__C.TRAIN.FG_CONN_WT = 1.
__C.TRAIN.MIN_FG_CVG = 0.1
__C.TRAIN.MIN_BG_CVG = 0.1
__C.TRAIN.RECON_WT = 1.
__C.TRAIN.FLAG = True
__C.TRAIN.NET_G = ''
__C.TRAIN.NET_D = ''
